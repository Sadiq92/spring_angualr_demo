...
public class Controller {
	...
	@PostMapping(path = "/save-student", consumes = "application/json", produces = "application/json")
	public boolean saveStudent(@RequestBody Student student) {
		System.out.println(student.getStudent_id()+" "+student.getStudent_name()+" "+student.getStudent_email()+" "+student.getStudent_branch());
